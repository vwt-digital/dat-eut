...
api=$(curl -s 'https://'"$2"'.appspot.com/openapi.json' | (python -c "
import sys
import json
accepted_keys = ''
...
if [ $? -eq 0 ];then echo "EAC PASSED: All endpoints were tested";else echo "EAC FAILED: Not all endpoints were tested";exit 1;fi 
